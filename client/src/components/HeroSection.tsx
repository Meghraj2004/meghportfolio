          ...
          >
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="bg-primary-DEFAULT hover:bg-primary-dark text-white font-medium px-6 py-3 rounded-lg transition-colors flex items-center"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-background-surface hover:bg-gray-800 text-white font-medium px-6 py-3 rounded-lg transition-colors flex items-center"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
