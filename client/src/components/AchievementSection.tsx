...
const AchievementSection: React.FC = () => {
  const achievements: Achievement[] = [
    {
      title: "2nd Prize, Phoenix 2026 – Web Craft AI",
      period: "March 2026",
      description: "Won 2nd prize at the Web Craft AI event hosted by Godavari College of Engineering, Jalgaon. Recognized for outstanding web development and AI integration skills.",
      icon: (
